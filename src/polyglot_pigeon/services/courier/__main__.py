"""Entry point: python -m polyglot_pigeon.services.courier"""

import logging

from polyglot_pigeon.shared.config import CourierSettings
...
def main() -> None:
    ...
    log.info("courier service starting in %s", settings.environment.value)
